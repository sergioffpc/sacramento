...
| `SDB-002-DC`, `DC-PROCESS-001` through `DC-PROCESS-015`, `DC-AUTHORITY-001` through `DC-AUTHORITY-009`, `DC-CLIENT-001` through `DC-CLIENT-010`, and `DC-COOKER-001` through `DC-COOKER-023` | `docs/design/training-simulation-design-commitments.csv` | Project owner | Exact Design Commitment identities, states, traces, owners, and acceptance-criterion approaches |
